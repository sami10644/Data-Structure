## BINARY SEACH BY Sami ##
import math
def binarysearch(arr,val): #time - 0(1, best), 0(logN, avg/worst)
    left_ptr = 0 #L
...
sami_arr = [8,9,12,15,17,19,20,21,28]
print(binarysearch(sami_arr,15))
print(binarysearch(sami_arr,29))
